...
public abstract class CharacterUtils {
   ...
   * In case code points can span across 2 java characters, this method may only
   * fill <code>numChars - 1</code> characters in order not to split in the
   * middle of a surrogate pair, even if there are remaining characters in the
   * {@link Reader}.
   * <p>
   * This method guarantees that the given {@link CharacterBuffer} will never
   * contain a high surrogate character as the last element in the buffer unless
   * it is the last available character in the reader. In other words, high and
   * low surrogate pairs will always be preserved across buffer boarders.
   * </p>
   * <p>
