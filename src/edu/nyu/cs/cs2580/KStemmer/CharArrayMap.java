...
public class CharArrayMap<V> extends AbstractMap<Object, V> {
  ...
  /**
   * Clears all entries in this map. This method is supported for reusing, but
   * not {@link Map#remove}.
   */
  @Override
  public void clear() {
  ...
  /**
   * Add the given mapping. If ignoreCase is true for this Set, the text array
   * will be directly modified. The user should never modify this text array
  ...
  /**
   * Returns an {@link CharArraySet} view on the map's keys. The set will use
  ...
  /**
   * Empty
   * {@link org.apache.lucene.analysis.util.CharArrayMap.UnmodifiableCharArrayMap}
   * optimized for speed. Contains checks will always return <code>false</code>
