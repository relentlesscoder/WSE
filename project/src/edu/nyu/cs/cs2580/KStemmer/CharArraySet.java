...
/**
 * A simple class that stores Strings as char[]'s in a hash table. Note that
 ...
 * representation. The add methods will use {@link Object#toString} and store
 * the result using a {@code char[]} buffer. The same behavior have the
 * {@code contains()} methods. The {@link #iterator()} returns an
 * {@code Iterator<char[]>}.
 */
public class CharArraySet extends AbstractSet<Object> {
  ...
  /**
   * Add this char[] directly to the set. If ignoreCase is true for this Set,
   * the text array will be directly modified. The user should never modify this
   * text array after calling this method.
   */
